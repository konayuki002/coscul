...
iron_ore = Repo.insert!(%Item{name: "鉄鉱石", stack: 50, is_liquid: false})
iron_plate = Repo.insert!(%Item{name: "鉄板", stack: 100, is_liquid: false})
copper_ore = Repo.insert!(%Item{name: "銅鉱石", stack: 50, is_liquid: false})
copper_plate = Repo.insert!(%Item{name: "銅板", stack: 100, is_liquid: false})
copper_wire = Repo.insert!(%Item{name: "銅線", stack: 200, is_liquid: false})
electric_circuit = Repo.insert!(%Item{name: "電子基板", stack: 200, is_liquid: false})
...
drawing_wire = Repo.insert!(%Recipe{time: 0.5, recipe_category_id: recipe_category_assembler.id})
...
assemble_circuit =
  Repo.insert!(%Recipe{time: 1.25, recipe_category_id: recipe_category_assembler.id})
